...
public class BranchSpikePriorTest {
    ...
    public void noRateShiftsSingleTypeCaseTest() {
        ...
        bsp.initByName("parameterization", parameterization, "tree", myTree, "gammaShape", "1.0", "spikes", "1.0 0.5 0.1 0.2 0.7 0.1");
        ...
        */
        ...
        assertEquals(-3.4385926164063445, bsp.calculateLogP(), 1e-5);
