...
//
//
//@Description("Logs a tree with expected hidden speciation events and spike sizes per branch")
//public class PunctuatedClockTreeLogger extends TreeWithMetaDataLogger {
//
//
//    public Input<RealParameter> spikesInput = new Input<>("spikes", "Spike sizes per branch", Input.Validate.REQUIRED);
//
